...
type GetVerificationKey =
  "v1"
    ...
    :> Get '[JSON] Crypto.VerificationKey

getVerificationKey :: UserId -> UserId -> MyServeHandler Crypto.VerificationKey
getVerificationKey _ recipientUserId = do
